export const translations = {
  en: {
    ...
    matches: {
      ...
      skipGroup: "Skip",
      joined: "Joined!",
      welcomeMessage: "Welcome to {groupName}! Slack channel created.",
      yourGroups: "Your Groups",
      openSlack: "Open Slack",
      commonInterests: "Common Interests",
      members: "Members",
      nextMeeting: "Next",
      findPerfectGroup: "Find your perfect group",
    },
    notifications: {
  ...
  fr: {
    ...
    matches: {
      title: "Vos Groupes",
      findMatch: "Trouver un Groupe",
      noMatches: "Aucun groupe encore",
      ...
      skipGroup: "Passer",
      joined: "Rejoint !",
      welcomeMessage: "Bienvenue dans {groupName} ! Canal Slack créé.",
      yourGroups: "Vos Groupes",
      openSlack: "Ouvrir Slack",
      commonInterests: "Intérêts Communs",
      members: "Membres",
      nextMeeting: "Prochain",
      findPerfectGroup: "Trouvez votre groupe parfait",
    },
    notifications: {
